...
public class AddFoodOrgPanel extends javax.swing.JPanel {
                ...
                jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(lbluserName)
                                        .addComponent(txtOrgID, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(23, 23, 23)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        .addComponent(lblpassword)
                                        .addComponent(txtOrgName, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(18, 18, 18)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnNextActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnNextActionPerformed
        ...
        if (orgName.isEmpty() || location.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Organization name and location cannot be empty", "Error",
        ...
        for (NetWork net : foodShelterSystem.getNetworkList()) {
            for (BasicEnterprise be : net.getEnterpriseDirectory().getEnterprises()) {
                if (be instanceof FoodEnterprise) {
                    ...
                    if (orgExists) {
                        JOptionPane.showMessageDialog(this, "An organization with this name already exists.", "Error",
                                JOptionPane.ERROR_MESSAGE);
                        return;
                    }
                    ...
                    workArea.add("AddLocalAdminPanel",
                            new AddLocalAdminPanel(workArea, account, foodShelterSystem, parent, newOrg, be));
        ...
        if (!foundFoodEnterprise) {
            JOptionPane.showMessageDialog(this,
                    "No Food Enterprise found in the system. Please create a Food Enterprise first.", "Error",
                    JOptionPane.ERROR_MESSAGE);
        }
