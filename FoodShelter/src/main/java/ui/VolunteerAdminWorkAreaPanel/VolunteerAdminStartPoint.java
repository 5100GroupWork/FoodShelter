...
public class VolunteerAdminStartPoint extends javax.swing.JPanel {
    ...
    public VolunteerAdminStartPoint(JPanel workArea, UserAccount account, BasicOrganization organization,
        ...
        initComponents();
        System.out.println(
                "VolunteerAdminStartPoint构造函数 - account: " + (account != null ? account.getUsername() : "null"));
        System.out.println(
                "VolunteerAdminStartPoint构造函数 - enterprise: " + (enterprise != null ? enterprise.getName() : "null"));
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                .addGap(28, 28, 28)
                                                .addComponent(lblWelcome, javax.swing.GroupLayout.PREFERRED_SIZE, 186,
    ...
    private void btnManageDriverActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnManageDriverActionPerformed
        ...
        workArea.add("DriverAdminWorkAreaPanel",
                new DriverAdminWorkAreaPanel(workArea, account, volunteerOrg, volunteerEnterprise, netWork));
    ...
    private void btnManageTaskManagerActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnManageTaskManagerActionPerformed
        ...
        workArea.add("TaskManagerAdminWorkPanel",
                new TaskManagerAdminWorkPanel(workArea, account, volunteerOrg, volunteerEnterprise, netWork));
